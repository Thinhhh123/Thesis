...
image_BGR = cv2.imread('F:\\python3.9\\fish_pics.jpg')
...
network = cv2.dnn.readNetFromDarknet('F:\\python3.9\\video_test_fish\\yolov3-custom.cfg','F:\\python3.9\\video_test_fish\\yolov3-custom_final.weights')
